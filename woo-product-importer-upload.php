    ...
    <form enctype="multipart/form-data" method="post" action="<?php echo get_admin_url().'tools.php?page=woo-product-importer&action=preview'; ?>">
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    <th><label for="import_csv_url">URL to Import</label></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="button" type="button" id="show_advanced_settings">Advanced Settings &darr;</button>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div id="advanced_settings">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr>
                        <th><label for="user_locale">Set Locale</label></th>
                        <td>
                            <?php if(count($locale_options) == 0) : ?>
                                <ul class="import_error_messages">
                                    <li>Couldn't get a list of available locales from your server.</li>
                                </ul>
                            <?php endif;?>
                            ...
                            <p class="description">If you have special characters in your CSV, (such as &aelig;, &szlig;, &eacute;, etc.) set this to a locale compatible with those characters.</p>
                        </td>
                    </tr>
                </tbody>
            </table>
